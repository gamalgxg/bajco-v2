...
import GetInTuch from "./componants/Get-in-tuch";
    ...
    <>
      ...
      <section className="relative mt-20">
        <div className="container-fluid md:mx-4 mx-2">
          <div
            style={{
              backgroundImage: `url('/images/bg/مغاسل_رخام_باجكو.jpg')`,
            }}
              ...
              <div className="grid grid-cols-1">
                <div className="ltr:md:text-left rtl:md:text-right text-center">
                  <h1 className="font-bold text-white lg:leading-normal leading-normal text-4xl lg:text-5xl mb-6">
                    باجكو
                    <br /> تفصيل{" "}
                    <span className="text-green-600">مغاسل رخام </span> فخمه
                  </h1>
                  <p className="text-white/70 text-xl max-w-xl">
                    تصميم وتفصيل ديكورات ومغاسل رخامية فخمه في الرياض.
                  </p>
                </div>
              </div>
            </div>
